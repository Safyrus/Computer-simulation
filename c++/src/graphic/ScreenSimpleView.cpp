...
graphic::ScreenSimpleView::ScreenSimpleView(std::shared_ptr<computer::RAM> ram)
{
    this->ram = ram;
    w = 128;
    h = 128;
...
graphic::ScreenSimpleView::~ScreenSimpleView()
{

}

void graphic::ScreenSimpleView::draw(sf::RenderWindow &window)
{
    // create pixels array
...
void graphic::ScreenSimpleView::setColor(sf::Color c)
{
    color = c;
}

void graphic::ScreenSimpleView::setBackgroundColor(sf::Color c)
{
    backgroundColor = c;
}
