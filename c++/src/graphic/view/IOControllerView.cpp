...
graphic::view::IOControllerView::IOControllerView(std::shared_ptr<computer::IOController> ioCtrl)
{
    this->ioCtrl = ioCtrl;
...
graphic::view::IOControllerView::~IOControllerView()
{
}

void graphic::view::IOControllerView::draw(sf::RenderWindow &window)
{
    // draw the background
