...
graphic::view::MenuView::MenuView(std::shared_ptr<data::menu::Menu> menu)
{
    this->menu = menu;
    scale = 1;
...
graphic::view::MenuView::MenuView(std::shared_ptr<data::menu::Menu> menu, bool vertical)
{
    this->menu = menu;
    scale = 1;
    if (!font.loadFromFile("pix46.ttf"))
...
graphic::view::MenuView::~MenuView()
{
}
...
void graphic::view::MenuView::setMousePos(int x, int y)
{
...
void graphic::view::MenuView::setMousePressed(bool pressed)
{
...
void graphic::view::MenuView::setMouseReleased(bool released)
{
...
void graphic::view::MenuView::setScale(int scale)
{
    if (scale > 0)
    {
        this->scale = scale;
